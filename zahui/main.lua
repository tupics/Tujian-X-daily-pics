...
SHORTCUT_TABLE={
  {"ID1","随机壁纸",intent1,"res/compass.png"},
  {"ID2","今日插画",intent2,"res/chahua.png"},
  {"ID3","今日杂烩",intent3,"res/zahui.png"},
}
...
if 界面传入参数=="杂烩" then
  加载杂烩()
 elseif 界面传入参数=="随机" then
  加载随机()
 elseif 界面传入参数=="插画" then
  加载插画()
 elseif 界面传入参数=="nil" then
  加载杂烩()
 else
  加载杂烩()
end
